...
class SubunitAPI extends Endpoint implements CrudEndpoint
{
    ...
    public const PARAMETER_EMPNUMBER = 'empNumber';
    ...
    private function getCommonBodyValidationRules(): array
    {
        return [
            ...
            new ParamRule(self::PARAMETER_EMPNUMBER),
        ];
    }
    ...
    private function setParamsToSubunit(Subunit $subunit): Subunit
    {
        ...
        $empNumber = $this->getRequestParams()->getIntOrNull(RequestParams::PARAM_TYPE_BODY, self::PARAMETER_EMPNUMBER);
        ...
        $subunit->getDecorator()->setEmployeeByEmpNumber($empNumber);
        return $subunit;
    }
