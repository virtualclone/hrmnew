...
class UserAPI extends Endpoint implements CrudEndpoint
{
    ...
    public const PARAMETER_PAYROLL = 'payrollAdmin';
    ...
    public function setUserParams(User $user, bool $changePassword = true): void
    {
        ...
        $payrolladmin = $this->getRequestParams()->getBoolean(RequestParams::PARAM_TYPE_BODY, self::PARAMETER_PAYROLL);

        $user->setUserName($username);
        $user->setStatus($status);
        $user->setPayrollAdmin($payrolladmin);
