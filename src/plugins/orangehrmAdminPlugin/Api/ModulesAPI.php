...
class ModulesAPI extends Endpoint implements CrudEndpoint
{
    ...
    public const PARAMETER_REPORTS = 'reports';
    public const PARAMETER_LOAN = 'loan';
    ...
    protected const CONFIGURABLE_MODULES = [
        ...
        self::PARAMETER_REPORTS => false,
        self::PARAMETER_LOAN => false,
    ];
     ...
     *             @OA\Property(property="directory", type="boolean"),
     *             @OA\Property(property="claim", type="boolean"),
     *             @OA\Property(property="loan", type="boolean"),
     *             @OA\Property(property="reports", type="boolean")
     *         )
     *     ),
