...
class ProjectAPI extends Endpoint implements CrudEndpoint
{
    ...
    public const PARAMETER_FORALL = 'forall';
    ...
    public const FILTER_USER_NUMBER = 'userNumber';
    ...
    public function getAll(): EndpointCollectionResult
    {
        ...
        $projectParamHolder->setUserNumber(
            $this->getRequestParams()->getIntOrNull(
                RequestParams::PARAM_TYPE_QUERY,
                self::FILTER_USER_NUMBER
            )
        );
        ...
        $projectParamHolder->setIncludeStatus(
            $this->getRequestParams()->getStringOrNull(
                RequestParams::PARAM_TYPE_QUERY,
    ...
    private function setProject(Project $project): void
    {
        ...
        $project->setForAll(
            $this->getRequestParams()->getIntOrNull(
                RequestParams::PARAM_TYPE_BODY,
                self::PARAMETER_FORALL
            )
        );

        $project->setActivestatus(
            $this->getRequestParams()->getIntOrNull(
                RequestParams::PARAM_TYPE_BODY,
    ...
    public function update(): EndpointResult
    {
        ...
        $projectActive = $this->getRequestParams()->getInt(RequestParams::PARAM_TYPE_BODY, self::PARAMETER_ACTIVE);
        if($projectActive== false)
        {
            $hasTimesheetItems = $this->getProjectService()->getProjectDao()->hasTimesheetItemsForProject($id);
            if ($hasTimesheetItems) {
                throw new BadRequestException('Not Allowed to deactivate Project(s) Which Have Time Logged Against Them');
            }
        }
        $project = $this->getProjectService()->getProjectDao()->getProjectById($id);
        $this->throwRecordNotFoundExceptionIfNotExist($project, Project::class);
