...
class Customer
{
     ...
     */
      ...
      * @var int 
      * 
      * @ORM\Column(name="cust_duration", type="integer", length=4) 
      */ 
     private int $custduration;
     ...
     */
      ...
      * @return int 
      */ 
     public function getCustduration(): int 
     { 
         return $this->custduration; 
     }
 
  
 
     /** 
      * @param int $custduration 
      */ 
     public function setCustduration(int $custduration): void 
     { 
