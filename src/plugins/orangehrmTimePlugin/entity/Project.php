...
class Project
{
     ...
     * @var bool
     *
     * @ORM\Column(name="active_status", type="boolean", options={"default" : 1})
     */
     ...
     * @var bool
     *
     * @ORM\Column(name="all_status", type="boolean", options={"default" : 0})
     */
     ...
     * @ORM\ManyToMany(targetEntity="OrangeHRM\Entity\Employee", cascade={"persist", "remove"})
     * @ORM\JoinTable(
     *     name="ohrm_project_employee",
     *     joinColumns={@ORM\JoinColumn(name="project_id", referencedColumnName="project_id")},
     *     inverseJoinColumns={@ORM\JoinColumn(name="emp_number", referencedColumnName="emp_number")}
     * )
     */
    private iterable $projectUsers;
     ...
     * @return iterable|Employee[]
     */
    public function getProjectUsers(): iterable
    {
     ...
     */
      ...
      * @param  bool  $forall 
      */
      public function setForAll(bool $forall): void 
     { 
         $this->forall = $forall; 
     }
