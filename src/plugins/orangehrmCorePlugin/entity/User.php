...
class User
{
     ...
     * @var bool
     *
     * @ORM\Column(name="payrolladmin", type="boolean")
     */
    private bool $payrolladmin;
     ...
     * @return bool
     */
    public function getPayrollAdmin(): bool
    {
        return $this->payrolladmin;
    }

    /**
     * @param bool $payrolladmin
     */
    public function setPayrollAdmin(bool $payrolladmin): void
    {
