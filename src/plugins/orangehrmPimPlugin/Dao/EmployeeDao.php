...
class EmployeeDao extends BaseDao
{
    ...
    protected function getEmployeeListQueryBuilderWrapper(
        ...
        $q->leftJoin('employee.workshifts', 'workshift');
        ...
        //Added for workshift
        if (!is_null($employeeSearchParamHolder->getWorkShiftId())) {
            $q->andWhere('workshift.id = :workshiftId')
                ->setParameter('workshiftId', $employeeSearchParamHolder->getWorkShiftId());
        }
        //end
