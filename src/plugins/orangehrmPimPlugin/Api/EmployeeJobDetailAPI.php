...
class EmployeeJobDetailAPI extends Endpoint implements ResourceEndpoint
{
    ...
    public const PARAMETER_WORKSHIFT_ID = 'workshiftId';
    //public const PARAMETER_WORKWEEK_ID = 'workweekId';
    ...
    public function update(): EndpointResourceResult
    {
        ...
        $effectiveDate = $this->getRequestParams()->getDateTimeOrNull(
            RequestParams::PARAM_TYPE_BODY,
        ...
        $employee->getDecorator()->setWorkshiftById($workshiftId);
