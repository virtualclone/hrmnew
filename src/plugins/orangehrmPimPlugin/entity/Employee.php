...
class Employee
{
     ...
     * @var WorkShift[]
     *
     * @ORM\ManyToMany(targetEntity="OrangeHRM\Entity\WorkShift", inversedBy="employees")
     * @ORM\JoinTable(
     *     name="ohrm_employee_work_shift",
     *     joinColumns={@ORM\JoinColumn(name="emp_number", referencedColumnName="emp_number")},
     *     inverseJoinColumns={@ORM\JoinColumn(name="work_shift_id", referencedColumnName="id")}
     * )
     */
    private iterable $workshifts;
     ...
     * @return WorkShift[]
     */
    public function getWorkshifts(): iterable
    {
        return $this->workshifts;
    }

    /**
     * @param WorkShift[] $workshifts
     */
    public function setWorkshifts(iterable $workshifts): void
    {
