 ...
 */
class ProjectUser extends \OrangeHRM\Entity\ProjectUser implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'OrangeHRM\\Entity\\ProjectUser' . "\0" . 'id', '' . "\0" . 'OrangeHRM\\Entity\\ProjectUser' . "\0" . 'project', '' . "\0" . 'OrangeHRM\\Entity\\ProjectUser' . "\0" . 'employee', '' . "\0" . 'OrangeHRM\\Entity\\ProjectUser' . "\0" . 'projectId', 'entityDecorator'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ProjectUser $proxy) {
