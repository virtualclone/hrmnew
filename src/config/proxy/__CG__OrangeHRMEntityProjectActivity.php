 ...
 */
class ProjectActivity extends \OrangeHRM\Entity\ProjectActivity implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'OrangeHRM\\Entity\\ProjectActivity' . "\0" . 'id', '' . "\0" . 'OrangeHRM\\Entity\\ProjectActivity' . "\0" . 'project', '' . "\0" . 'OrangeHRM\\Entity\\ProjectActivity' . "\0" . 'deleted', '' . "\0" . 'OrangeHRM\\Entity\\ProjectActivity' . "\0" . 'name', '' . "\0" . 'OrangeHRM\\Entity\\ProjectActivity' . "\0" . 'timesheetItems', '' . "\0" . 'OrangeHRM\\Entity\\ProjectActivity' . "\0" . 'activestatus', 'entityDecorator'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ProjectActivity $proxy) {
     ...
     * {@inheritDoc}
     */
    public function getProject(): \OrangeHRM\Entity\Project
    {
     ...
     * {@inheritDoc}
     */
    public function setProject(\OrangeHRM\Entity\Project $project): void
    {
