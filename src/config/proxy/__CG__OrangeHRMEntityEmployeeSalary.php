 ...
 */
class EmployeeSalary extends \OrangeHRM\Entity\EmployeeSalary implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'OrangeHRM\\Entity\\EmployeeSalary' . "\0" . 'id', '' . "\0" . 'OrangeHRM\\Entity\\EmployeeSalary' . "\0" . 'employee', '' . "\0" . 'OrangeHRM\\Entity\\EmployeeSalary' . "\0" . 'payGrade', '' . "\0" . 'OrangeHRM\\Entity\\EmployeeSalary' . "\0" . 'currencyType', '' . "\0" . 'OrangeHRM\\Entity\\EmployeeSalary' . "\0" . 'amount', '' . "\0" . 'OrangeHRM\\Entity\\EmployeeSalary' . "\0" . 'payPeriod', '' . "\0" . 'OrangeHRM\\Entity\\EmployeeSalary' . "\0" . 'salaryName', '' . "\0" . 'OrangeHRM\\Entity\\EmployeeSalary' . "\0" . 'comment', '' . "\0" . 'OrangeHRM\\Entity\\EmployeeSalary' . "\0" . 'directDebit', '' . "\0" . 'OrangeHRM\\Entity\\EmployeeSalary' . "\0" . 'effectiveDate', 'entityDecorator'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EmployeeSalary $proxy) {
     ...
     * {@inheritDoc}
     */
    public function getPayPeriod(): ?\OrangeHRM\Entity\PayPeriod
    {
     ...
     * {@inheritDoc}
     */
    public function setPayPeriod(?\OrangeHRM\Entity\PayPeriod $payPeriod): void
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPayPeriod', [$payPeriod]);

        parent::setPayPeriod($payPeriod);
    }
    ...
    public function getSalaryName(): ?string
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSalaryName', []);

        return parent::getSalaryName();
    }
    ...
    public function setSalaryName(?string $salaryName): void
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSalaryName', [$salaryName]);

        parent::setSalaryName($salaryName);
    }
    ...
    public function setBirthday(?\DateTime $effectiveDate): void
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setBirthday', [$effectiveDate]);

        parent::setBirthday($effectiveDate);
    }
     ...
     * {@inheritDoc}
     */
    public function getDirectDebit(): ?\OrangeHRM\Entity\EmpDirectDebit
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDirectDebit', []);

        return parent::getDirectDebit();
    }

    /**
     * {@inheritDoc}
     */
    public function setDirectDebit(?\OrangeHRM\Entity\EmpDirectDebit $directDebit): void
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDirectDebit', [$directDebit]);

        parent::setDirectDebit($directDebit);
    }
