...
class Subunit extends \OrangeHRM\Entity\Subunit implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'OrangeHRM\\Entity\\Subunit' . "\0" . 'id', '' . "\0" . 'OrangeHRM\\Entity\\Subunit' . "\0" . 'name', '' . "\0" . 'OrangeHRM\\Entity\\Subunit' . "\0" . 'unitId', '' . "\0" . 'OrangeHRM\\Entity\\Subunit' . "\0" . 'description', '' . "\0" . 'OrangeHRM\\Entity\\Subunit' . "\0" . 'lft', '' . "\0" . 'OrangeHRM\\Entity\\Subunit' . "\0" . 'rgt', '' . "\0" . 'OrangeHRM\\Entity\\Subunit' . "\0" . 'level', '' . "\0" . 'OrangeHRM\\Entity\\Subunit' . "\0" . 'employee', '' . "\0" . 'OrangeHRM\\Entity\\Subunit' . "\0" . 'node', 'entityDecorator'];
        }
