 ...
 */
class CompensatoryOff extends \OrangeHRM\Entity\CompensatoryOff implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'OrangeHRM\\Entity\\CompensatoryOff' . "\0" . 'id', '' . "\0" . 'OrangeHRM\\Entity\\CompensatoryOff' . "\0" . 'date', '' . "\0" . 'OrangeHRM\\Entity\\CompensatoryOff' . "\0" . 'expireDate', '' . "\0" . 'OrangeHRM\\Entity\\CompensatoryOff' . "\0" . 'lengthHours', '' . "\0" . 'OrangeHRM\\Entity\\CompensatoryOff' . "\0" . 'lengthDays', '' . "\0" . 'OrangeHRM\\Entity\\CompensatoryOff' . "\0" . 'status', '' . "\0" . 'OrangeHRM\\Entity\\CompensatoryOff' . "\0" . 'employee', '' . "\0" . 'OrangeHRM\\Entity\\CompensatoryOff' . "\0" . 'duration', '' . "\0" . 'OrangeHRM\\Entity\\CompensatoryOff' . "\0" . 'comments', '' . "\0" . 'OrangeHRM\\Entity\\CompensatoryOff' . "\0" . 'leaveType', '' . "\0" . 'OrangeHRM\\Entity\\CompensatoryOff' . "\0" . 'leaveTaken', 'entityDecorator'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CompensatoryOff $proxy) {
    ...
    public function setExpireDate(\DateTime $expireDate): void
    {
        ...
        parent::setExpireDate($expireDate);
    }
    ...
    public function getLeaveTaken(): ?int
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getLeaveTaken', []);

        return parent::getLeaveTaken();
    }
    ...
    public function setLeaveTaken(int $leaveTaken): void
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setLeaveTaken', [$leaveTaken]);

        parent::setLeaveTaken($leaveTaken);
    }
