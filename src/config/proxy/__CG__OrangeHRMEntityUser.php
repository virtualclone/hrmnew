...
class User extends \OrangeHRM\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'OrangeHRM\\Entity\\User' . "\0" . 'id', '' . "\0" . 'OrangeHRM\\Entity\\User' . "\0" . 'userName', '' . "\0" . 'OrangeHRM\\Entity\\User' . "\0" . 'userPassword', '' . "\0" . 'OrangeHRM\\Entity\\User' . "\0" . 'deleted', '' . "\0" . 'OrangeHRM\\Entity\\User' . "\0" . 'status', '' . "\0" . 'OrangeHRM\\Entity\\User' . "\0" . 'payrolladmin', '' . "\0" . 'OrangeHRM\\Entity\\User' . "\0" . 'dateEntered', '' . "\0" . 'OrangeHRM\\Entity\\User' . "\0" . 'dateModified', '' . "\0" . 'OrangeHRM\\Entity\\User' . "\0" . 'modifiedUserId', '' . "\0" . 'OrangeHRM\\Entity\\User' . "\0" . 'createdBy', '' . "\0" . 'OrangeHRM\\Entity\\User' . "\0" . 'employee', '' . "\0" . 'OrangeHRM\\Entity\\User' . "\0" . 'userRole', '' . "\0" . 'OrangeHRM\\Entity\\User' . "\0" . 'authProviders', 'entityDecorator'];
        }
    ...
    public function getPayrollAdmin(): bool
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPayrollAdmin', []);

        return parent::getPayrollAdmin();
    }
    ...
    public function setPayrollAdmin(bool $payrolladmin): void
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPayrollAdmin', [$payrolladmin]);

        parent::setPayrollAdmin($payrolladmin);
    }
