...
class Project extends \OrangeHRM\Entity\Project implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'OrangeHRM\\Entity\\Project' . "\0" . 'id', '' . "\0" . 'OrangeHRM\\Entity\\Project' . "\0" . 'customer', '' . "\0" . 'OrangeHRM\\Entity\\Project' . "\0" . 'name', '' . "\0" . 'OrangeHRM\\Entity\\Project' . "\0" . 'description', '' . "\0" . 'OrangeHRM\\Entity\\Project' . "\0" . 'deleted', '' . "\0" . 'OrangeHRM\\Entity\\Project' . "\0" . 'activestatus', '' . "\0" . 'OrangeHRM\\Entity\\Project' . "\0" . 'forall', '' . "\0" . 'OrangeHRM\\Entity\\Project' . "\0" . 'projectAdmins', '' . "\0" . 'OrangeHRM\\Entity\\Project' . "\0" . 'projectUsers', 'entityDecorator'];
        }
    ...
    public function getForAll(): bool
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getForAll', []);

        return parent::getForAll();
    }
    ...
    public function setForAll(bool $forall): void
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setForAll', [$forall]);

        parent::setForAll($forall);
    }
