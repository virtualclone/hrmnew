 ...
 */
class ProjectAdmin extends \OrangeHRM\Entity\ProjectAdmin implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'OrangeHRM\\Entity\\ProjectAdmin' . "\0" . 'project', '' . "\0" . 'OrangeHRM\\Entity\\ProjectAdmin' . "\0" . 'employee', '' . "\0" . 'OrangeHRM\\Entity\\ProjectAdmin' . "\0" . 'projectId', 'entityDecorator'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ProjectAdmin $proxy) {
