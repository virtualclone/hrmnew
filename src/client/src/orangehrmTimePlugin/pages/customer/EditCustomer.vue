  ...
  <div class="orangehrm-background-container">
    <div class="orangehrm-card-container">
      ...
      <oxd-form :loading="isLoading" @submit-valid="onSave">
        ...
        <oxd-form-row>
          <oxd-input-field
            v-model="customer.emailto"
            type="textarea"
            :label="$t('Email To')"
            placeholder="EX. abc@gmail.com, 123@domain.com"            
          />
        </oxd-form-row>
        <oxd-form-row>
          <oxd-input-field
            v-model="customer.mhrslimit"           
            :label="$t('Monthly Hours Limit (If not set Hrs is Unlimited.)')"
            placeholder="Hrs"            
          />
        </oxd-form-row>
  ...
  created() {
    ...
    this.http
      ...
      .then((response) => {
        ...
        this.customer.emailto = data.emailto;
        this.customer.mhrslimit = data.mhrslimit;
    ...
    onSave() {
      ...
      this.http
        .update(this.customerId, {
          ...
          emailto: this.customer.emailto,
          mhrslimit: this.customer.mhrslimit,
