      ...
      <oxd-form :loading="isLoading" @submit-valid="onSave">
        ...
        <oxd-form-row>
          <oxd-grid :cols="2" class="orangehrm-full-width-grid">
            ...
            <oxd-grid-item>
              <oxd-input-field v-model="project.active" type="checkbox" value="true" :label="$t('Active')"
