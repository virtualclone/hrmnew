...
<template>
  <oxd-dialog class="orangehrm-dialog-modal" @update:show="onCancel">
    ...
    <oxd-form :loading="isLoading" @submit-valid="onSave">
      <oxd-form-row>
        <oxd-input-field v-model="name" :label="$t('general.name')" :rules="rules.name" required />
      </oxd-form-row>
      <oxd-form-row>
        <oxd-input-field v-model="active" type="checkbox" value="true" :label="$t('Active')" :true-value="true"
          :false-value="false" />
      </oxd-form-row>
      <oxd-divider />
