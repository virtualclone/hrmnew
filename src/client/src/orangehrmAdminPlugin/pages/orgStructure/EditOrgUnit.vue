...
<template>
  <oxd-dialog class="orangehrm-dialog-modal" @update:show="onCancel">
    ...
    <oxd-form :loading="isLoading" @submit-valid="onSave">
      <oxd-form-row>
        <oxd-input-field v-model="orgUnit.unitId" :label="$t('admin.unit_id')" :rules="rules.unitId" />
      </oxd-form-row>
      <oxd-form-row>
        <oxd-input-field v-model="orgUnit.name" :label="$t('general.name')" :rules="rules.name" required />
      </oxd-form-row>
      <oxd-form-row>
        <oxd-input-field v-model="orgUnit.description" type="textarea" :label="$t('general.description')"
          :placeholder="$t('general.type_description_here')" :rules="rules.description" />
      </oxd-form-row>

      <oxd-form-row>
        <supervisor-dropdown v-model="orgUnit.empNumber" :subunitId="id" />
      </oxd-form-row>
