...
import EditDocument from './pages/document/EditDocument.vue'
import SaveDocument from './pages/document/SaveDocument.vue'
import ViewPayrollConfiguration from './pages/payrollConfiguration/ViewPayrollConfiguration.vue'
...
export default {
  ...
  'payroll-configuration-view': ViewPayrollConfiguration,
};
