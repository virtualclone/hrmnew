...
import CompensatoryApply from './pages/compensatoryOff/CompensatoryApply.vue';
import MyCompensatoryList from './pages/compensatoryOff/MyCompensatoryList.vue'
import CompensatoryApprove from './pages/compensatoryOff/CompensatoryApprove.vue'
import LeaveCalendar from './pages/LeaveCalendar.vue'
export default {
  ...
  'compensatory-apply' : CompensatoryApply,
  'my-compensatory-list': MyCompensatoryList,
  'approve-compensatory': CompensatoryApprove,
